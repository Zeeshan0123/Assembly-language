...
menu7 db 'Enter 7 to remove 01 Bike,Bus from your Parking $'
menu8 db 'Enter 8 to remove 01 Car,Cycle,Truck from your Parking $' 
menu9 db 'Enter 9 to remove 01 Bus from your Parking $'  
menu10 db 'Enter 10 to remove 01 Cycle,Truck,Car from your Parking $' 
menu11 db 'Enter 11 to remove 01 Truck from your Parking $'
menu12 db 'Press 9 to delete Your all record$'
